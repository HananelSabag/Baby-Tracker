...
// ── Icon categories — every icon earns its place ─────────────────────────────
//
// Category logic:
//   medicine  → tרופות ומינונים שנה ראשונה: ויטמין D (☀️), ברזל (🩸),
//               אקמול/נובימול (🌡️💊), אנטיביוטיקה (🦠), חיסון (💉),
//               טיפות (💧), סירופ (🧴), משחה (🫙), פלסטר פוסט-חיסון (🩹), רופא (🩺)
//   care      → שגרת היום: אמבטיה, החלפה, הנקה, שינה, עיסוי, שיר ערש
//   measure   → מדידות ריאליות: משקל, גובה, חום, מ"ל, דופק, זמן
//   activity  → פעילות התפתחותית בשנה הראשונה: תנועה, משחק, חושים
//   nature    → תוספי תזונה טבעיים: ויטמין C (🍋), אומגה 3 (🌊), צמחי מרפא (🌿)
//
export const TRACKER_ICON_CATEGORIES = [
  {
    id: 'medicine',
    label: 'תרופות ומינונים',
    icons: [
      '☀️',  // ויטמין D — "ויטמין השמש"
      '🩸',  // ברזל — תוסף ברזל / hemoglobin
      '💊',  // כדור — תרופה כללית
      '💉',  // זריקה — חיסון
      '🌡️', // חום — אקמול / נובימול / חיסון חום
      '🦠',  // אנטיביוטיקה — נלחם בחיידקים
      '💧',  // טיפות — D טיפות / ברזל נוזלי
      '🧴',  // סירופ — תרופה נוזלית
      '🍯',  // סירופ שיעול — רכיב דבש
      '🩹',  // פלסטר — לאחר חיסון
      '🩺',  // רופא — ביקורת / מרשם
      '🫙',  // משחה — קרם / אינטל / ניסטטין
    ],
  },
  {
    id: 'care',
